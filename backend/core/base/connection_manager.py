...
class PlexManagerProtocol(Protocol):
    ...
    async def get_all_movies(self) -> list[dict[str, Any]]:
        """Get all movies from the Plex application. \n
        Returns:
            list[dict[str, Any]]: The movies from the Plex application."""
        raise NotImplementedError("Subclasses must implement this method")
    
    async def get_all_series(self) -> list[dict[str, Any]]:
        """Get all series from the Plex application. \n
        Returns:
            list[dict[str, Any]]: The series from the Plex application."""
        raise NotImplementedError("Subclasses must implement this method")
